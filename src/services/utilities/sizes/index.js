...
export const sizes = {
  ...
  buttonRadius: Platform.OS === 'ios' ? 16 : 16,
  inputHeight: Platform.OS === 'ios' ? height * 0.07 : height * 0.07,
  buttonHeight: Platform.OS === 'ios' ? height * 0.07 : height * 0.07,
  smallButtonHeight: Platform.OS === 'ios' ? height * 0.05 : height * 0.05,

  modalRadius: 15,
  cardRadius: Platform.OS === 'ios' ? 16 : 16,
...
export const fontSizes = {
  ...
  extraLarge: responsiveFontSize(22),
